...
--
-- Host: localhost:3306
-- Generation Time: Jul 30, 2017 at 03:09 AM
...
(2, 'CSE11', 'Dsrv', 'Rahul', 'M', '1999-12-25', NULL, NULL, 'uejd', 'wejied', 98767, 'cdi dowd', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '');
...
INSERT INTO `volunteer` (`Volunteer_id`, `Name`, `Area`, `GovtID`, `IDno`, `Hospital`, `Approved`, `Points`, `email`, `password`) VALUES
(1, 'xyz', 'andheri', 'adhaar', 123456789, 'tata', 1, 10, '', ''),
(2, 'rr', 'rr', '22', 323, 'dfsdf', 0, 1, '', ''),
(3, 'rr', 'rr', '22', 323, 'dfsdf', 0, 1, '', ''),
(4, '$name', '$area', '$govtid', 0, '$hospital', 0, 0, '$email', '$password'),
(5, '$name', '$area', '$govtid', 0, '$hospital', 0, 0, '$email', '$password'),
(6, 'name', 'area', '34', 55, 'hospital', 0, 0, 'email', 'password'),
(7, 'name', 'area', '34', 55, 'hospital', 0, 0, 'email', 'password'),
(8, '', '', '', 0, 'hospital', 0, 0, '', ''),
(9, '', '', '', 0, 'hospital', 0, 0, '', ''),
(10, 'ff', 'Gfc', '', 55, 'hospital', 0, 0, 'ff', 'ddfc');
...
--
-- AUTO_INCREMENT for table `childprofile`
--
ALTER TABLE `childprofile`
